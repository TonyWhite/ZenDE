...
function install_environment()
{
  ...
  echo "############################"
  echo "# Install Zen Applications #"
  echo "############################"
  mkdir -p "/usr/bin"
  mkdir -p "/usr/share/applications"
  mkdir -p "/usr/share/pixmaps"
  
  mkdir -p "/usr/share/zen-de"
  cd "/usr/share/zen-de"
  NAME="zen-logo.svg"
  ...
  wget "${ZEN_REPO}/usr/bin/${NAME}"
  chmod +x "${NAME}"
  mkdir -p "/usr/share/zen-de/brightness"
  cd "/usr/share/zen-de/brightness"
  wget "${ZEN_REPO}/usr/share/zen-de/brightness/${NAME}.svg"
  cd "/usr/share/pixmaps"
  ln -s "/usr/share/zen-de/brightness/${NAME}.svg" "/usr/share/pixmaps/${NAME}.svg"
  cd "/usr/share/applications"
  wget "${ZEN_REPO}/usr/share/applications/${NAME}.desktop"
  chmod +x "${NAME}.desktop"
